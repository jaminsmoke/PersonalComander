...
Antes de empezar, lee el [README](README.md) y [`AGENTS.md`](AGENTS.md) (secciones **Familia PersonalHostel** y **Oficios**): este repo es la app **del camarero**. Los repos hermanos están en esa tabla. El puesto del negocio vive en Personal Bar; Identity es el registro canónico en el VPS (Docker en el servidor, no en el host). No conviertas Commander en expo de barra.
